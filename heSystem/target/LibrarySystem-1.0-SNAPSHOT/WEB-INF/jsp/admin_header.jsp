...
<nav style="position:fixed;z-index: 999;width: 100%;background-color: #25c6fc" class="navbar navbar-default"
    ...
    <div class="container-fluid">
        <div class="navbar-header" style="margin-left: 8%;margin-right: 1%">
            <a class="navbar-brand" href="admin_main.html" style="font-family: 华文行楷; font-size: 250%; color: white">健康管理系统</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-left">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="admin_books.html">全部饮食</a></li>
                        <li class="divider"></li>
                        <li><a href="book_add.html">增加饮食</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: white">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="lendlist.html">收藏日志</a></li>
                    </ul>
                </li>
                <li >
